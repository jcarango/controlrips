              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title"> Informe Archivo de usuarios - US</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                      <form method="post" name="buscar" action="informeUS.php">
...
<script type="text/javascript" src="scripts/informeUS.js"></script>
<script type="text/javascript">
    ...
    $("#Buscar").click(function() {
          tabla=$('#tbllistado').dataTable(
          {
            ...
            "ajax":
                {
                  url: '../ajax/informeUS.php?op=buscar&fechainicio='+$("#fechainicio").val()+'&fechafin='+$("#fechafin").val(),
                  type : "get",
                  dataType : "json",
                  error: function(e){
