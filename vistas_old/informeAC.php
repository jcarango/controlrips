                      ...
                      <form method="post" name="buscar" action="informeAC.php">
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            ...
                            <th>Autorizacion</th>
                            <th>Cod Consulta</th>
                            <th>Finalidad Consulta</th>
                            <th>Causa Externa</th>
                            <th>Cod Diagnóstico Ppal</th>
                            <th>Cod Diagnóstico Rel</th>
                            <th>Cod Diagnóstico Rel</th>
                            <th>Cod Diagnóstico Rel</th>
...
<script type="text/javascript" src="scripts/informeAC.js"></script>
...
<script type="text/javascript">
    ...
    $("#Buscar").click(function() {
          tabla=$('#tbllistado').dataTable(
          {
            ...
            "ajax":
                {
                  url: '../ajax/informeAC.php?op=buscar&fechainicio='+$("#fechainicio").val()+'&fechafin='+$("#fechafin").val(),
                  type : "get",
                  dataType : "json",
                  error: function(e){
