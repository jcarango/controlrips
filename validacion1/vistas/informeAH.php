              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title"> Informe Archivo de hospitalización - AH: Por rango de fechas</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                      <form method="post" name="buscar" action="informeAH.php">
...
<script type="text/javascript" src="scripts/informeAH.js"></script>
<script type="text/javascript">
    ...
    $("#Buscar").click(function() {
          tabla=$('#tbllistado').dataTable(
          {
            ...
            "ajax":
                {
                  url: '../ajax/informeAH.php?op=buscar&fechainicio='+$("#fechainicio").val()+'&fechafin='+$("#fechafin").val(),
                  type : "get",
                  dataType : "json",
                  error: function(e){
