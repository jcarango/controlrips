              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title"> Liquidación - AP: Por rango de fechas</h1>
...
<script type="text/javascript" src="scripts/informeliquidacionAP.js"></script>
<script type="text/javascript">
    ...
    $("#Buscar").click(function() {
          tabla=$('#tbllistado').dataTable(
          {
            ...
            "ajax":
                {
                  url: '../ajax/informeliquidacionAP.php?op=buscar&fechainicio='+$("#fechainicio").val()+'&fechafin='+$("#fechafin").val(),
                  type : "get",
                  dataType : "json",
                  error: function(e){
