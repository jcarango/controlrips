            ...
            switch ($clasearchivo) {
               ...
               case "AF":
                while (!feof($open)) 
                {
                 ...
                 if (empty($codprestadorservicio)){ 
                  if ($key['error']=='') //Si no existio ningun error, retornamos un mensaje por cada archivo subido
                    {
                      $mensage .= '-> Archivo <b>'.$NombreOriginal.'</b> Subido correctamente, por un valor de: $<b>'.$totalAF.'</b><br>';
                    }
                  } else {
              ...
              case "US":
                while (!feof($open)) 
                {
                 ...
                 $qry = "INSERT INTO US (tipoidentificacion, numeroidentificacion, codigoentidadadministradora, tipousuario, primerapellido, segundoapellido, primernombre, segundonombre, edad, unidadmedidadedad, sexo, codigodepartamento, codigomunicipio, zonaresidencia) VALUES('$tipoidentificacion', '$numeroidentificacion', '$codigoentidadadministradora', '$tipousuario', '$primerapellido', '$segundoapellido', '$primernombre', '$segundonombre', '$edad', '$unidadmedidadedad', '$sexo', '$codigodepartamento', '$codigomunicipio', '$zonaresidencia')";
                 mysqli_query($conexion,$qry);
               }
                }
                fclose($open);
              ...
              case "AP":
                while (!feof($open)) 
                {
                 ...
                 $qry = "INSERT INTO AP (numerofactura, codigoprestadorserviciossalud, tipoidentificacion, numeroidentificacion, fechaprocedimiento, numeroautorizacion, codigoprocedimiento, ambitorealizacionprocedimiento, finalidadprocedimiento, personalqueatiende, diagnosticoprincipal, diagnosticorelacionado, complicacion, formarealizacionactoquirurgico, valorprocedimiento) VALUES('$numerofactura', '$codigoprestadorserviciossalud', '$tipoidentificacion', '$numeroidentificacion', '$fechaprocedimiento1', '$numeroautorizacion', '$codigoprocedimiento', '$ambitorealizacionprocedimiento', '$finalidadprocedimiento', '$personalqueatiende', '$diagnosticoprincipal', '$diagnosticorelacionado', '$complicacion', '$formarealizacionactoquirurgico', '$valorprocedimiento')";
                 mysqli_query($conexion,$qry);
               }
                }
                fclose($open);
              ...
              ) VALUES('$numerofactura', '$codigoprestadorserviciossalud', '$tipoidentificacion', '$numeroidentificacion', '$fechaingresousuario1', '$horaingreso', '$numeroautorizacion', '$causaexterna', '$diagnosticosalida', '$diagnosticorelacionadosalida1', '$diagnosticorelacionadosalida2', '$diagnosticorelacionadosalida3', '$destinousuariosalidaobservacion', '$estadosalida', '$causabasicamuerteurgencias', '$fechasalidaobservacion1', '$horasalidaobservacion')";
                 mysqli_query($conexion,$qry);
               }
                }
                fclose($open);
              ...
              case "AM":
                while (!feof($open)) 
                {
                 ...
                 $qry = "INSERT INTO AM (numerofactura, codigoprestadorserviciossalud, tipoidentificacion, numeroidentificacion, numeroautorizacion, codigomedicamento, tipomedicamento, nombregenericomedicamento, formafarmaceutica, concentracionmedicamento, unidadmedidamedicamento, numerounidades, valorunitariomedicamento, valortotalmedicamento) VALUES('$numerofactura', '$codigoprestadorserviciossalud', '$tipoidentificacion', '$numeroidentificacion', '$numeroautorizacion', '$codigomedicamento', '$tipomedicamento', '$nombregenericomedicamento', '$formafarmaceutica', '$concentracionmedicamento', '$unidadmedidamedicamento', '$numerounidades', '$valorunitariomedicamento', '$valortotalmedicamento')";
                 mysqli_query($conexion,$qry);
               }
                }
                fclose($open);
              ...
              case "AD":
                while (!feof($open)) 
                {
                 ...
                 $qry = "INSERT INTO AD (numerofactura, codprestadorservicio, codigodeconcepto, cantidad, valorunitario, valortotal) VALUES('$numerofactura', '$codprestadorservicio', '$codigodeconcepto', '$cantidad', '$valorunitario', '$valortotal')";
                 mysqli_query($conexion,$qry);
               }
                }
                fclose($open);
...
$qry = "INSERT INTO totaldia (nit, totalAF, totalAT, totalAM, totalAC, totalAP, diferencia, fechaingreso, usuario) VALUES('$nit', '$totalAF', '$totalAT', '$totalAM', '$totalAC', '$totalAP', '$totaldia', '$hoy', '$usuario')";
mysqli_query($conexion,$qry);
?>
