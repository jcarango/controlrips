              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title"> Informe Archivo de recién nacidos - AN: Por rango de fechas</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                      <form method="post" name="buscar" action="informeAN.php">
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            ...
                            <th>Sexo</th>
                            <th>Peso</th>
                            <th>Diag Reciennacido</th>
                            <th>Causa Muerte</th>
                            <th>Fecha Muerte/Hora</th>
                          </thead>
                          <tbody>
                          </tbody>
                          <tfoot>
...
<script type="text/javascript" src="scripts/informeAN.js"></script>
<script type="text/javascript">
    ...
    $("#Buscar").click(function() {
          tabla=$('#tbllistado').dataTable(
          {
            ...
            "ajax":
                {
                  url: '../ajax/informeAN.php?op=buscar&fechainicio='+$("#fechainicio").val()+'&fechafin='+$("#fechafin").val(),
                  type : "get",
                  dataType : "json",
                  error: function(e){
